...
namespace Assessment_ClientApp2
{
    ...
    class Program
    {
        ...
        static void DisplayFilterMonster()
        {
        ...
        static void DisplayMenuScreen(List<Monster> monsters)
        {
            ...
            do
            {
                ...
                Console.WriteLine("\tf) Filter Monster by age");
        ...
        static void DisplayAddMonster(List<Monster> monsters)
        {
            ...
            Console.Write("\tTribe: ");
            Enum.TryParse(Console.ReadLine(), out Monster.Tribe tribes);
            newMonster.Tribes = tribes;
        ...
        static void DisplayUpdateMonster(List<Monster> monsters)
        {
            ...
            Console.Write($"\tCurrent Tribe: {selectedMonster.Tribes} New Tribe: ");
            userResponse = Console.ReadLine();
            if (userResponse != "")
            {
                Enum.TryParse(userResponse, out Monster.Tribe tribe);
                selectedMonster.Tribes = tribe;
            }
            Console.Write($"\tCurrent Birth Month: {selectedMonster.BirthMonth} New Birth Month: ");
            userResponse = Console.ReadLine();
            if (userResponse != "")
            {
                selectedMonster.BirthMonth = userResponse;
            }
        ...
        static void MonsterInfo(Monster monster)
        {
            ...
            Console.WriteLine($"\tTribe: {monster.Tribes}");
            Console.WriteLine($"\tBirthMonth: {monster.BirthMonth}");
